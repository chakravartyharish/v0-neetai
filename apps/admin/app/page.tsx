          ...
          <div className="lg:col-span-2">
            <div className="bg-white p-6 rounded-lg shadow-sm">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <Button variant="outline" className="justify-start h-auto p-4 flex-col items-start" onClick={handleAnalytics}>
                  <div className="flex items-center w-full mb-2">
                    <svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <Button variant="outline" className="justify-start h-auto p-4 flex-col items-start" onClick={handleSettings}>
                  <div className="flex items-center w-full mb-2">
                    <svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
